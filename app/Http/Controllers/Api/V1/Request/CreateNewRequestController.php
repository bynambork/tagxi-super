...
//outstation Rides outstationRides
    ...
    {
     $request_detail =  Request::where('driver_id', $user->driver->id)->where('is_completed', false)->where('is_cancelled', false)->where('is_out_station', true)->get();  
    }

      $request_result =  fractal($request_detail, new TripRequestTransformer)->parseIncludes(['userDetail','driverDetail']);
